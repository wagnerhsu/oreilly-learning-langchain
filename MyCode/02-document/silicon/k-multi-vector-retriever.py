...
llm = ChatOpenAI(temperature=0, model=model_name, base_url=base_url, api_key=api_key)
summarize_chain = {
...
# Add the document summaries to the vector store for similarity search (batched to avoid API 413 error)
BATCH_SIZE = 64
