...
model_low_temp = ChatOpenAI(model=model_name, base_url=base_url, api_key=api_key,temperature=0.1)
# useful to generate natural language outputs
model_high_temp = ChatOpenAI(model=model_name, base_url=base_url, api_key=api_key,temperature=0.7)
